...
export default function ChatLayout() {
  ...
  useEffect(() => {
    ...
    if (location.search === '?type=about') {
      go('/about');
    }

    if (location.search === '?type=home') {
      go('/home');
    }
      ...
      {isDashboard ? (
        ...
        <Layout style={{ minHeight: '100vh' }} hasSider>
          ...
          <Layout
            ...
            style={{
              marginLeft: hideSideBar ? 0 : collapsed ? 80 : 200,
              transition: hideSideBar ? undefined : 'margin-left 300ms ease-out',
            }}
          >
            <Content
